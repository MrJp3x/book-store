...
class ProductType(TimeStamp):
    """
    Define product type. For example is the product e-book, v-book or ...
...
class Product(TimeStamp):
    ...
    Attributes:
        ...
        is_available (models.BooleanField): Is product available or not.
...
class Book(Product):
    ...
    Attributes:
        ...
        categories (models.ForeignKey): The category to which the book belongs.
